...
- [Aurora Station](https://github.com/shakc04/aurora-station), a real-time cinematic environment

The page is plain static HTML and CSS, served with GitHub Pages.

## Images

The two project shots live in `assets/`:
